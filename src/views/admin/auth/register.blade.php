    ...
    <div class="uk-container-center auth-container">
        <div class="uk-grid background-blue">
            ...
            <div class="uk-width-1-1 uk-width-medium-1-2 text-container">
                <h1>L!ROCK</h1>
                <form class="uk-form uk-form-stacked" method="POST" action="{{ url('/register') }}">
                    ...
                    <div class="uk-form-row">
                        {!! csrf_field() !!}
                        <button type="submit" class="uk-button uk-button-large uk-width-1-1">Зарегистрироваться</button>
                    </div>
                </form>
            </div>
        </div>
